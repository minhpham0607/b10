...
import cartItemsData from '../b10/products.json';

const imageMapping = {
    "Scan Screen.png": require('../b10/Images/Scan Screen.png'),
    "Rectangle 31.png": require('../b10/Images/Rectangle 31.png'),
    "Rectangle 45.png": require('../b10/Images/Rectangle 45.png'),
  };
      ...
      <View style={styles.footer}>
        ...
        >
          <View style={selectedIcon === 'Home' ? styles.selectedIconBackground : null}>
            <Image
              source={require('../b10/Images/Group 152.png')}
        ...
        >
          <View style={selectedIcon === 'Cart' ? styles.selectedIconBackground : null}>
            <Image
              source={require('../b10/Images/Group 153.png')}
        ...
        >
          <View style={selectedIcon === 'Scan' ? styles.selectedIconBackground : null}>
            <Image
              source={require('../b10/Images/Vector.png')}
        ...
        >
          <View style={selectedIcon === 'Favorite' ? styles.selectedIconBackground : null}>
            <Image
              source={require('../b10/Images/Group 154.png')}
        ...
        >
          <View style={selectedIcon === 'Profile' ? styles.selectedIconBackground : null}>
            <Image
              source={require('../b10/Images/Group 161.png')}
